...
<template>
  <main class="pt-[6.25rem]">
    <div
      ...
      <p>The app does use third-party services that may collect information used to identify you. Links to the privacy
        policy of third-party service providers used by the app:</p>
      <ul>
        <li>
          Google Firebase Authentication: Is used to create and manage user accounts. We collect a user's password and
          email address for authentication purposes. See the following page:
          <a href="https://firebase.google.com/support/privacy/">Firebase Privacy Policy</a>
        </li>
        <li>Sentry: Is used to log errors that occur whilst using the app. The privacy policy can be found at <a
            href="https://sentry.io/privacy">Sentry Privacy Policy</a>.
        </li>
      </ul>
